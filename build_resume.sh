python yml_to_resume.py --output=resume.html

python yml_to_resume.py --pages=1 --output=resume_page_1.html
google-chrome resume_page_1.html --headless --print-to-pdf=resume_page_1.pdf --no-pdf-header-footer
rm resume_page_1.html

python yml_to_resume.py --pages=2 --output=resume_page_2.html
